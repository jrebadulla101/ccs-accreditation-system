...
// Check if user has permission to add programs
if (!hasPermission('add_program')) {
    setFlashMessage("danger", "You don't have permission to add programs.");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || empty($code)) {
        setFlashMessage("danger", "Name and Code are required fields.");
    } else {
        // Check if code already exists
        $checkQuery = "SELECT id FROM programs WHERE code = ?";
        ...
        if ($result->num_rows > 0) {
            setFlashMessage("danger", "Program code already exists. Please use a different code.");
        } else {
            // Insert new program
            $insertQuery = "INSERT INTO programs (name, code, description, status) VALUES (?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                ...
                $activityType = "program_create";
                $description = "Created new program: $name";
                ...
                setFlashMessage("danger", "Error creating program: " . $conn->error);
            }
        }
    }
}
...
<head>
    ...
    <title>Add Program - CCS Accreditation System</title>
                ...
                <div class="form-container">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-row">
                            ...
                            <small class="form-text">Unique identifier for the program (e.g., BSCS, BSIT)</small>
                        </div>
                        
                        <div class="form-row">
                            <label for="name">Program Name *</label>
                            <input type="text" id="name" name="name" class="form-control" required>
                            <small class="form-text">Full name of the program (e.g., Bachelor of Science in Computer Science)</small>
                        </div>
